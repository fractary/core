/**
 * @fractary/core - Error Types
 *
 * Hierarchical error classes for the Core SDK.
 */
 ...
 */
export class WorkError extends CoreError {
  constructor(message: string, code: string, details?: Record<string, unknown>) {
 ...
 */
export class RepoError extends CoreError {
  constructor(message: string, code: string, details?: Record<string, unknown>) {
    super(message, code, details);
    this.name = 'RepoError';
  }
 ...
 */
export class SpecError extends CoreError {
 ...
 */
export class LogError extends CoreError {
  constructor(operation: string, message: string, details?: Record<string, unknown>) {
 ...
 */
export class WorkflowError extends CoreError {
  constructor(message: string, details?: Record<string, unknown>) {
 ...
 */
export class CommandExecutionError extends CoreError {
