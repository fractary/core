...
**Location:** `plugins/work/skills/fractary-work-common/scripts/config-loader.sh`

**Usage:**
```bash
CONFIG_JSON=$(./plugins/work/skills/fractary-work-common/scripts/config-loader.sh) || exit $?
...
```bash
# Load configuration
if ! CONFIG_JSON=$(./plugins/work/skills/fractary-work-common/scripts/config-loader.sh 2>&1); then
...
**Location:** `plugins/work/skills/fractary-work-common/scripts/check-config-exists.sh`
...
**Planned Usage:**
```bash
NORMALIZED=$(./plugins/work/skills/fractary-work-common/scripts/normalize-issue.sh "$PLATFORM" "$ISSUE_JSON")
```
...
**Planned Usage:**
```bash
./plugins/work/skills/fractary-work-common/scripts/validate-issue-id.sh "github" "123"
```
...
**Planned Usage:**
```bash
source ./plugins/work/skills/fractary-work-common/scripts/error-codes.sh
exit $ERR_NOT_FOUND
```
...
./plugins/work/skills/fractary-work-common/scripts/config-loader.sh
...
WORK_COMMON_DIR="$SCRIPT_DIR/../../fractary-work-common/scripts"
