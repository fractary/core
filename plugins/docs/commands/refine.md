...
allowed-tools: Agent(fractary-docs:docs-refiner)
model: claude-haiku-4-5
argument-hint: '<id> [--context "<text>"]'
---

Use **Agent** tool with `fractary-docs:docs-refiner` agent to refine a document through gap scanning and interactive Q&A.
